...
// All of the Math and canvas methods expect and return values in radians rather than degrees. Mathematically, radians are easier to work with in the confines of a programming language, so nearly all languages will use radians for circle and arc calculations. To read more about radians, check out this article. Using the Math.PI property, create a function that will convert radians to degrees.
